...
def run():
    ...
    parser.add_argument('--test_images', type=str, default='./test_image_TNO/', help='path of source image')
    ...
    fusion_model.load_state_dict(
        torch.load("saved_models/%s/model_fusion%s.pth" % (args.dataset_name, args.weights), map_location='cuda:0'))
